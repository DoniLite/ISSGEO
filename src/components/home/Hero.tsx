        ...
        <div className='flex flex-col relative lg:-left-[12rem] lg:gap-4 xl:gap-8'>
          ...
          <div className='flex w-full items-center gap-2 lg:gap-4 mt-4'>
            {/* <button
              ...
              type='button'
              className='bg-muted cursor-pointer lg:w-auto w-[50%] text-xs lg:text-lg text-muted-foreground lg:font-medium px-4 py-2 rounded-md hover:bg-muted/90'
            >
              {t('pages.home.ctas.contact')}
            </button> */}
            <Link
              to='/courses'
...
export function HeroForm() {
  ...
  useEffect(() => {
    // Only fetch when we don't have countries yet. Guard prevents repeated
    // calls; including fetchCountries in deps keeps the hook lint happy because
    // the store exposes a stable function.
    ...
    >
      <div className='w-full flex flex-col gap-1'>
        ...
        <input
          ...
          placeholder={t('pages.home.form.name.placeholder')}
        />
      </div>

      <div className='w-full flex flex-col gap-1 mt-2 lg:mt-4'>
        <span className='lg:text-lg font-bold relative left-3'>
          {t('pages.home.form.email.label')}
        </span>
        <input
          type='text'
          id='email'
      ...
      <div className='w-full flex flex-col gap-1 mt-2 lg:mt-4'>
        ...
        <div className='group rounded-md border flex items-center'>
          ...
          <input
            ...
            placeholder={t('pages.home.form.phone.placeholder')}
          />
        </div>
      </div>
